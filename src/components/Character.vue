...
<template>
  <div class="p-12 bg-gray-100 min-h-screen">
    <h1 class="text-3xl font-bold text-center mb-6">Character Component</h1>
    ...
    <div class="flex justify-center mt-6 space-x-4">
      <button
        ...
        class="px-4 py-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        Previous Page
      </button>
      <button
